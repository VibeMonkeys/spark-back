...
interface UserRewardJpaRepository : JpaRepository<UserRewardEntity, String> {
    ...
    fun findAvailableRewardsByUser(@Param("userId") userId: String, @Param("currentTime") currentTime: LocalDateTime): List<UserRewardEntity>
    ...
    fun findByUserIdAndExchangedAtBetween(userId: String, startDate: LocalDateTime, endDate: LocalDateTime): List<UserRewardEntity>
