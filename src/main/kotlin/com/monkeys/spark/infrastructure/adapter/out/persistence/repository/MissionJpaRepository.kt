...
interface MissionJpaRepository : JpaRepository<MissionEntity, String> {
    ...
    fun findByUserIdAndStatusIn(@Param("userId") userId: String, @Param("statuses") statuses: List<String>): List<MissionEntity>
    ...
    fun findByCategoryAndDifficulty(@Param("category") category: String, @Param("difficulty") difficulty: String): List<MissionEntity>
    ...
    fun findMissionsAssignedBetween(@Param("startDate") startDate: LocalDateTime, @Param("endDate") endDate: LocalDateTime): List<MissionEntity>
    
    // MissionPersistenceAdapter에서 필요한 추가 메서드들
    fun findByUserIdAndCreatedAtBetween(userId: String, startDate: LocalDateTime, endDate: LocalDateTime): List<MissionEntity>
    
    fun findByCategory(category: String): List<MissionEntity>
    
    fun findByDifficulty(difficulty: String): List<MissionEntity>
    
    fun findByCategoryAndDifficultyAndIdNot(category: String, difficulty: String, excludeId: String): List<MissionEntity>
    ...
    @Query(value = """
        ...
        LIMIT :limit
    """, nativeQuery = true)
    fun findRandomAvailableTemplatesForUser(@Param("userId") userId: String, @Param("limit") limit: Int): List<MissionEntity>
