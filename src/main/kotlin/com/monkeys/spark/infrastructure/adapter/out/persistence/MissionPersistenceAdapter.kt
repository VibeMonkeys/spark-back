...
class MissionPersistenceAdapter(
    ...
    override fun findSimilarMissions(category: MissionCategory, difficulty: MissionDifficulty, excludeId: MissionId, limit: Int): List<Mission> {
    ...
    override fun findMissionsByConditions(timeOfDay: String?, weatherCondition: String?, location: Location?): List<Mission> {
