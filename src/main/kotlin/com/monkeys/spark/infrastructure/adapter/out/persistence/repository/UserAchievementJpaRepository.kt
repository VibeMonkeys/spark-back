 ...
 */
@Repository
interface UserAchievementJpaRepository : JpaRepository<UserAchievementEntity, Long> {

    /**
     * 사용자 ID로 업적 목록 조회 (최신순)
     */
    fun findByUserIdOrderByUnlockedAtDesc(userId: Long): List<UserAchievementEntity>

    /**
     * 사용자 ID와 업적 타입으로 업적 조회
     */
    fun findByUserIdAndAchievementType(userId: Long, achievementType: AchievementType): UserAchievementEntity?
    ...
    fun countUnlockedByUserId(@Param("userId") userId: Long): Int
     ...
     */
    fun existsByUserIdAndAchievementType(userId: Long, achievementType: AchievementType): Boolean
